...
import { ISelectedPiece, ShapeType, SideType } from "../../../config/quantik.config";
...
const SelectedPiece = (piece: ISelectedPiece) => {
  ...
  return(
    <div ref={selectedShapeRef} className="flex justify-center align-center min-h-[6rem] min-w-[6rem]">
      {quantik.selectedPiece != -1 && <img draggable="false" src={ShapeImgUrl} className="w-24 h-24"></img>}
    </div>
  )
